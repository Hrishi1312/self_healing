...
def main():
    ...
    ap.add_argument("--scenarioagent", type=int, default=d("scenarioagentid", 654, int))
    ap.add_argument("--testcaseagent", type=int, default=d("testcaseagentid", 652, int))
    ap.add_argument("--reviewagent", type=int, default=d("reviewagentid", 653, int))
